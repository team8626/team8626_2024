...
/** Add your docs here. */
public class ArmExtensionIOReal implements ArmExtensionIO {
  ...
  /** Class States * */
  @AutoLogOutput private double m_desiredExtensionInches = 0;
  ...
  public void updateInputs(ArmExtensionInputs inputs) {
    inputs.currentExtInches = m_currentExtInches;
    inputs.armIsResetting = m_armIsResetting;
