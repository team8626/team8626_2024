...
public class RobotContainer {
  ...
  public Command getAutonomousCommand() {
    return m_drivebase.driveToPose(new Pose2d(FieldConstants.StagingLocations.centerlineTranslations[4].getX()-RobotConstants.intakeOffset.getX(),
                                              FieldConstants.StagingLocations.centerlineTranslations[4].getY()-RobotConstants.intakeOffset.getY(),
